...
parent_path='C:/Users/Asus/OneDrive/Desktop/BCG_CaseStudy'
...
print("Result 1: ", Primary_Person_Male_Accident_count)
...
print("Result 2: ", Two_wheeler_crash_count)

# 3. Analysis 3: Which state has highest number of accidents in which females are involved?
print("Result 3: ", df_Primary_Person[df_Primary_Person['PRSN_GNDR_ID']=='FEMALE'][['CRASH_ID','DRVR_LIC_STATE_ID']].groupby('DRVR_LIC_STATE_ID').nunique().nlargest(1,'CRASH_ID',keep='all'))
...
print("Result 4: ", top_5th_to_15th_VEH_MAKE_IDs)
...
print("Result 7: ", df_units_no_damage_detail['CRASH_ID'])
